...
export const metadata: Metadata = {
    title: "About Us | The Padival Grand Hotel - Our Story & Legacy",
    description:
        "Discover the story of The Padival Grand Hotel, established by Mahaveer Ventures. Learn about our heritage, values, and commitment to delivering exceptional hospitality in Puttur, Karnataka.",
    keywords: [
        "Padival Grand Hotel history",
        "Mahaveer Ventures",
        "about Padival Hotel",
        "hotel heritage Puttur",
        "hospitality Puttur",
    ],
    openGraph: {
        title: "About Us | The Padival Grand Hotel - Our Story & Legacy",
        ...
        url: "https://padivals-megamind.vercel.app//about",
    },
};
