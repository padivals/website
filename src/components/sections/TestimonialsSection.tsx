        ...
        <section className="bg-[#F9F5EC] py-20">
            <div className="container mx-auto px-6">
                ...
                <div className="flex flex-col md:flex-row justify-between items-end mt-16 gap-8">
                    {/* Rating Info */}
                    <div>
                        <h3 className="text-3xl font-serif text-[#0F2A1D] mb-1">4.3 Stars</h3>
                        <p className="text-[#4A6C58] text-sm mb-3">Average Rating by Past Guests</p>
                        <div className="flex gap-1 text-[#1B4D3E]">
                            ...
                            {/* Half/Empty Star representation - using a specific path or just a different color for the last one if needed. 
                                The screenshot shows 4 full stars and maybe a half or empty one. 
                                I'll use a star with a different fill or stroke for the last one to represent 4.3 */}
                            <div className="relative">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6 text-[#A3B19C] opacity-50">
                                    <path fillRule="evenodd" d="M10.788 3.21c.448-1.077 1.976-1.077 2.424 0l2.082 5.007 5.404.433c1.164.093 1.636 1.545.749 2.305l-4.117 3.527 1.257 5.273c.271 1.136-.964 2.033-1.96 1.425L12 18.354 7.373 21.18c-.996.608-2.231-.29-1.96-1.425l1.257-5.273-4.117-3.527c-.887-.76-.415-2.212.749-2.305l5.404-.433 2.082-5.006z" clipRule="evenodd" />
                                </svg>
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6 absolute top-0 left-0 overflow-hidden text-[#1B4D3E]" style={{ width: '30%' }}>
                                    <path fillRule="evenodd" d="M10.788 3.21c.448-1.077 1.976-1.077 2.424 0l2.082 5.007 5.404.433c1.164.093 1.636 1.545.749 2.305l-4.117 3.527 1.257 5.273c.271 1.136-.964 2.033-1.96 1.425L12 18.354 7.373 21.18c-.996.608-2.231-.29-1.96-1.425l1.257-5.273-4.117-3.527c-.887-.76-.415-2.212.749-2.305l5.404-.433 2.082-5.006z" clipRule="evenodd" />
                                </svg>
                            </div>
                        </div>
