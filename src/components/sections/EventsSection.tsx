...
const EventsSection = () => {
  const events = [
    {
      title: "Leisure",
      image: "/images/carddd.png", // Placeholder
    },
    {
      title: "Celebration",
      image: "/images/cardd.png", // Placeholder
    },
    {
      title: "Dining",
      image: "/images/card.png", // Placeholder
    },
  ];
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {events.map((event, index) => (
            <div key={index} className="flex flex-col group cursor-pointer">
              <div
                className="w-full aspect-[4/3] mb-6 overflow-hidden relative bg-cover bg-center"
